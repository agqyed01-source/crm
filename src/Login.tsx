...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-100 dark:bg-neutral-900 p-4">
        ...
        <CardContent>
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-neutral-950 px-2 text-muted-foreground">Or continue with</span>
            </div>
          </div>
      ...
      {/* Alert to remind users to enable email/password auth */}
      <div className="fixed bottom-4 right-4 max-w-sm bg-blue-50 text-blue-800 p-4 rounded-lg shadow-lg border border-blue-200">
        <h4 className="font-semibold mb-1">Developer Note</h4>
        <p className="text-xs">If email/password sign-in fails, ensure you have enabled the <strong>Email/Password</strong> provider in your Firebase project's Authentication settings.</p>
      </div>
    </div>
  );
}
